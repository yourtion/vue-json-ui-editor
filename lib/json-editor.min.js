...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_JsonEditor_vue__ = __webpack_require__(31);
...
const { initChild, getChild } = __webpack_require__(28);
...
const parseArray = (vm, schema, schemaName) => {
  const field = schema.attrs || {};
...
const loadFields = (vm, schema, fields = vm.fields, sub) => {
